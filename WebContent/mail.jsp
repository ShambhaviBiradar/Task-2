    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="addstudent.jsp">Add Student</a></li>
         ...
         <li class="active"><a href="">Mail Report</a></li>
        <li class=""><a href="attendance.jsp">Add Attendance</a></li>
        
        <li class=""><a href="attendancedetails.jsp">Attendance Report</a></li>
    	 ...
    	 // int rollno = Integer.parseInt(request.getParameter("studentRollno"));
    	  ...
    	  String user = (String)session.getAttribute("user");
			...
			while (rs.next()) {
				...
				String usnno = rs.getString("std_usn"); 
				String sub01 = rs.getString("sub01");
				String sub02 = rs.getString("sub02"); 
				String sub03 = rs.getString("sub03"); 
				String sub04 = rs.getString("sub04"); 
				String sub05 = rs.getString("sub05"); 
				String sub06 = rs.getString("sub06");
				String max_obt = rs.getString("Max_obt");
				String max_marks = rs.getString("Max_marks");
				String result = rs.getString("result");
				String remarks = rs.getString("remarks");
				
				res = "<h2> Hello Parents </h2>"
				+"<br> <h2> Result Report of your Child </h2>"
				...
				+"<td>"+usnno+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>SUB 01</td>"
				+"<td>"+sub01+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>SUB 02</td>"
				+"<td>"+sub02+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>SUB 03</td>"
				+"<td>"+sub03+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>SUB 04</td>"
				+"<td>"+sub04+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>SUB 05</td>"
				+"<td>"+sub05+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>SUB 06</td>"
				+"<td>"+sub06+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>Marks Obtained</td>"
				+"<td>"+max_obt+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>Max Marks</td>"
				+"<td>"+max_marks+"</td>"
				+"</tr>"
				+"<tr><td class='labelName'>Result</td>"
				+"<td>"+result +"%</td>"
				+"</tr>"
				+"<tr><td class='labelName'>Remarks</td>"
				+"<td>"+remarks+"</td>"
				+"</tr>"
   				+"</tbody></table>"
   				+"<br>"
